                             ...
                             Bundle savedInstanceState)
    {
        ...
        continueBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                AddCarFragmentDirections.ActionAddCarFragmentToAddCarDescriptionFragment action = AddCarFragmentDirections.actionAddCarFragmentToAddCarDescriptionFragment(temp_owner,temp_model,temp_year,temp_price,temp_location,temp_phone);
